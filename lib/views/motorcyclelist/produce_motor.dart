import 'package:arionmotor/views/motorcyclelist/motor_model.dart';
...
class ProduceMotor extends StatefulWidget {
  @override
  State<ProduceMotor> createState() => _ProduceMotorState();
}

class _ProduceMotorState extends State<ProduceMotor> {
  ...
  TextEditingController mainColorController = TextEditingController();
  ...
  ProduceMotor(frameNumber, produtionYear, brand, type, engineType,
    ...
    }).then((value) =>
    {
      ...
      Fluttertoast.showToast(msg: "Motor Information is added successfully!"),
    });
  }
