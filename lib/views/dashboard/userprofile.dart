...
class _UserProfileState extends State<UserProfile> {
      ...
      await users
        ...
        if (documentSnapshot.exists) {
          ...
          (data).forEach((key, value) {
            if(key == 'name'){
              nameController = TextEditingController(text:value.toString());
            }else if(key == 'secondName'){
              secondNameController = TextEditingController(text:value.toString());
            }else if(key == 'thirdName'){
              thirdNameController = TextEditingController(text: value.toString());
            }else if(key == 'lastName'){
              lastNameController = TextEditingController(text:value.toString());
            }else if(key == 'nationalNumber'){
              nationalNumberController = TextEditingController(text:value.toString());
            }else if(key == 'phoneNumber'){
              phoneNumberController = TextEditingController(text:value.toString());
            }else if(key == 'dateBirth'){
              dateBirthController = TextEditingController(text:value.toString());
            }else if(key == 'address'){
              addressController = TextEditingController(text:value.toString());
            }else if(key == 'email'){
              emailController = TextEditingController(text:value.toString());
  ...
  UserProfile(id,fname, secondName, thirdName, lastName, dateBirth, email, nationalNumber, phoneNumber, address) async {
    ...
    users.doc(id).update({
      ...
      Navigator.pop(context),prefs.setString('imgUrl', imgUrl),
      Fluttertoast.showToast(msg: "User Information is updated successfully!"),
    });
  }
  ...
  Widget _previewIdFront() {
    ...
    if (_idFrontFile != null || idFrontImage.isNotEmpty) {
      if(_idFrontFile != null) {
        return
          kIsWeb
              ? Image.network(_idFrontFile!.path, fit: BoxFit.fill,)
              : Image.file(File(_idFrontFile!.path,), fit: BoxFit.fill,);
      }else{
  ...
  Widget _previewIdBack() {
    ...
    if (_idBackFile != null || idBackImage.isNotEmpty) {
      if(_idBackFile != null) {
        return
          kIsWeb
              ? Image.network(_idBackFile!.path, fit: BoxFit.fill,)
              : Image.file(File(_idBackFile!.path,), fit: BoxFit.fill,);
      }else{
                    ...
                    children: [
                      Container(
                        ...
                        child: !kIsWeb && defaultTargetPlatform == TargetPlatform.android
                          ...
                          builder: (BuildContext context, AsyncSnapshot<void> snapshot_img) {
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FloatingActionButton(
                              ...
                              backgroundColor: Colors.orange,
                              onPressed: () {
                                _onFrontButtonPressed(ImageSource.gallery, context: context);
                              },
                              tooltip: 'Select an Image',
                              child: const Icon(Icons.upload),
                            ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FloatingActionButton(
                              ...
                              backgroundColor: Colors.orange,
                              onPressed: () {
                                _onBackButtonPressed(ImageSource.gallery, context: context);
                              },
                              tooltip: 'Select an Image',
                              child: const Icon(Icons.upload),
                            ),
